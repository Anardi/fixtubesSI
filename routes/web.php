...
Route::controller(pembayaranController::class)->group(function () {
    ...
    Route::get('/pembayaran/edit/{id_pembayaran}', 'edit')->name('editPembayaran');
    Route::post('/pembayaran/update/{id_pembayaran}', 'update')->name('updatePembayaran');
...
Route::controller(poliklinikController::class)->group(function () {
    ...
    Route::get('/poliklinik/edit/{id_kode_poliklinik}', 'edit')->name('editPoliklinik');
    Route::post('/poliklinik/update/{id_kode_poliklinik}', 'update')->name('updatePoliklinik');
    Route::delete('/poliklinik/{id_kode_poliklinik}','delete')->name('deletePoliklinik');
});
