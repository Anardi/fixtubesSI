        ...
        <div class="container">
          <!--
           <div class="row g-3 align-items-center mt-2">
             ...
             <div class="row">
              <a href ="#" onclick="exportTableToPDF('Data Pemeriksaan', 'pemeriksaan')" class="btn btn-outline-info mb-3">Export PDF</a>
                 <div class="col-lg-12">
                    @if (session('success'))
                         ...
                         <table id="example1" class="table table-bordered table-striped">
                           ...
                           <tbody>
                            ...
                            <tr>
                              ...
                              <td>
                                <a href="{{ route('editPemeriksaan', $key->kode_pemeriksaan) }}" class="btn btn-info btn-sm mx-1" >
                                    <i class="fas fa-edit"></i>
                                  </a>
                                    <form action="{{ route('deletePemeriksaan', $key->kode_pemeriksaan) }}" method="post" class="d-inline">
                                        @method('delete')
                                        @csrf
