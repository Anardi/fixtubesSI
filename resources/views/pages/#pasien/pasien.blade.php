                 ...
                 <div class="col-auto">
                   ...
                   <div class="col-auto">
                      <input type="search" id="inputPassword6" class="form-control" aria-labelledby="passwordHelpInline">
                        ...
                        <div class="row">
                            <a href="#" onclick="exportTableToPDF('Data Pasien', 'pasien')" class="btn btn-outline-info mb-3">Export PDF</a>
                            <div class="col-lg-12">
                                @if (session('success'))
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($pasien as $key)
                                                        <tr>
                                                            ...
                                                            <td>{{ $key->gol_darah }}</td>
                                                            <td>
                                                                <a href="{{ route ('editPasien', $key->kode_pasien) }}" class="btn btn-info btn-sm mx-1">
