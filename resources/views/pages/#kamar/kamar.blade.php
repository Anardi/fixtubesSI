        ...
        <div class="container">
          <!--
           <div class="row g-3 align-items-center mt-2">
             ...
             <div class="row">
              <a onclick="exportTableToPDF('Data Kamar', 'kamar')" class="btn btn-outline-info mb-3">Export PDF</a>
                 <div class="col-lg-12">
                    @if (session('success'))
                              ...
                              <tr>
                                ...
                                <td>
                                  <a href="{{ route('editKamar', $key->kode_kamar) }}" class="btn btn-info btn-sm mx-1" >
                                    ...
                                    <form action="{{ route('deleteKamar', $key->kode_kamar) }}" method="post" class="d-inline">
                                        @method('delete')
                                        @csrf
