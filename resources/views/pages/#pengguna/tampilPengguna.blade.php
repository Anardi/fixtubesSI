        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-8">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('updatePengguna', $pengguna->id_pengguna) }}" method="POST">
                                @csrf
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="id_pengguna" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp" value="{{ $pengguna->id_pengguna }}">
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Pegawai</label>
                                    <select name="id_pegawai" class="form-control">
                                        @foreach ($pegawai as $item)
                                            <option value="{{ $item->id_pegawai }}" {{ $item->id_pegawai == $pengguna->id_pegawai ? 'selected' : '' }}>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="username" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp" value="{{ $pengguna->username }}">
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Password</label>
                                    <input type="text" name="password" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp" value="{{ $pengguna->password }}">
                                </div>
