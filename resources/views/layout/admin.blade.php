    ...
    <div class="wrapper">
        ...
        <script>
            function exportTableToPDF(title, filename) {
                ...
                doc.setFontSize(16); // Ukuran font judul
                ...
                for (var i = 1; i < table.rows.length; i++) {
                    ...
                    for (var j = 0; j < tableRow.cells.length - 1; j++) {
                        rowData.push(tableRow.cells[j].innerText); // Menggunakan innerText untuk mengambil teks dari elemen
                    }
                    data.push(rowData);
                }
                ...
                doc.autoTable({
                    head: [headers],
                    body: data,
                    startY: 20, // 20 mm dari atas
                    styles: {
            cellPadding: 2, // Mengatur padding sel menjadi 2 (sesuaikan dengan kebutuhan)
            lineHeight: 1, // Mengatur tinggi baris menjadi 1 (sesuaikan dengan kebutuhan)
        },
                });
